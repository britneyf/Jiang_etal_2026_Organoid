...
log_dir=/data/chanjlab/$project/logs_new/mast.ZFPKD_vs_CTRL_per_condition.042224/
...
for sample in `ls /home/chanj3/chanjlab/CRC_ZFP36L2.092023/Organoid/output.042224/stratified/raw_counts`; do
    bsub -sla llSC4 -R A100 -q cpuqueue -J "mast_$sample" -n 15 \
         ...
         "source ~/anaconda3/etc/profile.d/conda.sh; conda activate multiome_env; ~/anaconda3/envs/multiome_env/bin/Rscript --vanilla /home/chanj3/chanjlab/CRC_ZFP36L2.092023/Organoid/scripts/organoid_analysis_pipeline_scripts/run_mast.ZFPKD_vs_CTRL.by_condition.R $sample"
done
