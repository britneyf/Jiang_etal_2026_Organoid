...
log_dir=/data/chanjlab/$project/logs_new/mast.ZFPKD_Tissue_Interact.by_culture.adjust_replicate.042224/
...
for culture in HISC BASE Dedifferentiated; do
    bsub -sla llSC4 -R A100 -q cpuqueue -J "mast_$culture" -n 15 \
         ...
         "source ~/anaconda3/etc/profile.d/conda.sh; conda activate multiome_env; ~/anaconda3/envs/multiome_env/bin/Rscript --vanilla /home/chanj3/chanjlab/CRC_ZFP36L2.092023/Organoid/scripts/organoid_analysis_pipeline_scripts/run_mast.ZFPKD_Tissue_Interact.by_culture.adjust_replicate.R $culture"
done
