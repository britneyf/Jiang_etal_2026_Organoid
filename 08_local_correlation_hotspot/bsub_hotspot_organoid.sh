...
bsub -sla llSC4 -R A100 -q cpuqueue -J hotspot_organoid -n 30 -R rusage[mem=5] -W 10:00 -o hotspot_organoid.%J.stdout -eo hotspot_organoid.%J.stderr "source ~/anaconda3/etc/profile.d/conda.sh; conda activate scrna; /home/forsythb/anaconda3/envs/scrna/bin/python /data/chanjlab/CRC_ZFP36L2.092023/Organoid/scripts/organoid_analysis_pipeline_scripts/run_hotspot_organoid.py"
