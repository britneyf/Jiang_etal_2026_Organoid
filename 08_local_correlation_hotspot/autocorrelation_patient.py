...
out_dir = '/data/chanjlab/CRC_ZFP36L2.092023/Organoid/output_noreplicates/calclocalcorr/080724/'
...
rho_mat.astype(np.float16).to_csv(out_dir + 'local_corr.ZFP36L2.patient.csv', sep = ',')
